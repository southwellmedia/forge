...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Base
      "flex h-11 w-full items-center justify-between rounded-lg px-4 py-3 text-sm",
      // Background states
      "bg-input-bg hover:bg-input-bg-hover data-[state=open]:bg-background",
      // Border (subtle 1px border, colored on focus/open)
      "border border-border/40 focus:border-primary data-[state=open]:border-primary",
